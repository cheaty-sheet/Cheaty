...
const HTML_renderer_1 = __importDefault(require("./modules/renderers/HTMLRenderer/HTML.renderer"));
...
class CheatySheet {
    constructor(title = "Cheaty Sheet Cheat Sheet", description = "A Cheat Sheet for Cheaty Sheet, by @CheatySheet.", size = "A4") {
        this.title = title;
...
//# sourceMappingURL=CheatySheet.js.map